...
โปรเจ็คนี้ได้ตั้งค่าให้เข้ากับ Firebase เป็นที่เรียบร้อยแล้ว คุณสามารถนำไฟล์ `google-services.json(ของคุณ)` ที่ได้มาจากการเพิ่มแอปพลิเคชันบน Firebase มาแทนที่ไฟล์ `google-services.json(ของโปรเจค)` ได้เลยโดยไม่ต้องปรับปรุงโค้ดส่วนอื่น
